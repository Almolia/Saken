class UserMessages:
    ...
    ACCOUNT_STATUS_UPDATED = "وضعیت حساب کاربر با موفقیت به‌روزرسانی شد."
    SELF_STATUS_IMMUTABLE = "امکان غیرفعال‌کردن حساب جاری وجود ندارد."
    ADMIN_STATUS_IMMUTABLE = "امکان تغییر وضعیت حساب ادمین وجود ندارد."
...
class PollMessages:
    ...
    POLL_DELETED = "نظرسنجی با موفقیت حذف شد."
    ONLY_DRAFT_CAN_BE_DELETED = "فقط نظرسنجی‌های در وضعیت پیش‌نویس قابل حذف هستند؛ نظرسنجی منتشرشده را ببندید."

    OPTION_NOT_IN_POLL = "گزینه انتخاب‌شده متعلق به این نظرسنجی نیست."
    POLL_NOT_ACTIVE = "این نظرسنجی در حال حاضر فعال نیست."
    POLL_ENDED = "مهلت رأی‌گیری این نظرسنجی به پایان رسیده است."
    RESIDENT_NOT_IN_TARGET_UNITS = "هیچ‌یک از واحدهای شما در فهرست واحدهای هدف این نظرسنجی نیست."
    ALREADY_VOTED = "شما قبلاً در این نظرسنجی رأی داده‌اید."
    VOTE_SUCCESS = "رأی شما با موفقیت ثبت شد."