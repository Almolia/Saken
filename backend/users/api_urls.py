...
urlpatterns = [
    ...
    path("auth/profile/", SelfProfileUpdateView.as_view(), name="self-profile-update"),
    path("auth/change-password/", SelfPasswordChangeView.as_view(), name="self-change-password"),
